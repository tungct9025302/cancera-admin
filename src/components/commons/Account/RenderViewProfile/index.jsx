...
import { viewProfileInputsForAdmins } from "../../FormSource";
          ...
          >
            <Stack spacing={1}>
              {fetchedList["role"] === "admin"
                ? viewProfileInputsForAdmins.map((input) => {
                    return (
        ...
        <AlertDialogFooter justifyContent="flex-start">
          {/* <Box>
            <Text fontSize="0.875em" fontStyle="italic">
              If you want to modify any information, kindly press the{" "}
              <b>request</b> button above.
            </Text>
          </Box> */}
        </AlertDialogFooter>
      </AlertDialogContent>
